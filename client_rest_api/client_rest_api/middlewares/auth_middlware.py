...
class AuthTokenMiddleware:
    def __init__(self, get_response):
        ...
        self.whitelist = [ '/admin', '/static', '/media', '/users' , '/payment/match2pay-pay-out-webhook/', '/payment/match2pay-pay-in-webhook/','/payment/cheezeepay-upi-payout-webhook/', '/payment/cheezeepay-upi-payin-webhook/']
