...
class WithdrawalApprovals(TimeStampModel):
    ...
    first_approval_name = models.CharField(max_length=250, unique=False, blank=True, null=True)
    ...
    second_approval_name = models.CharField(max_length=250, unique=False, blank=True, null=True)
